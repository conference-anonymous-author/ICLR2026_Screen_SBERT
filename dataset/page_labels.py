...
Instagram_page2screen_indices = {
    '인스타 메인 화면': [0, 38, 53, 57, 69, 80, 85, 86, 87, 92, 99, 110, 126, 133, 161, 167], 
    '타인 스토리': [1, 2, 3, 16, 17, 18, 21, 23, 25, 27, 29, 30, 56, 115, 116], 
    '스토리 추가': [4], 
    'Notification': [5, 44, 47, 48], 
    'DM 목록': [6, 65, 66], 
    '검색 초기': [7, 50, 113, 124, 130, 153], 
    '메인화면 게시물 옵션': [8], 
    '포스트 추가': [9, 54, 79, 97, 114, 132, 164], 
    '사진, 릴스 Explore': [10, 52, 74, 75, 76, 78, 82, 103, 104, 129, 163], 
    '타인 프로필': [11, 19, 24, 31, 43, 46, 49, 51, 58, 59, 60, 68, 72, 111, 119, 123, 135, 150, 152, 165], 
    '내 프로필': [12, 55, 81, 112, 137, 144, 145, 146, 147, 155, 162], 
    #'메인화면 로고 클릭': [13], 
    '스토리 답장': [14, 20, 26], 
    '공유': [15, 22, 28, 102], 
    '스토리 임시저장': [32], 
    ...
    '팔로잉 옵션': [118],
    '타인 프로필 옵션': [120],
    '프로필 notification': [121],
    '포스트': [122, 125, 128, 134, 140, 157],
    '링크인': [127],
    '팔로잉, 팔로워 목록': [131, 136, 141, 158, 160],
    '게시물 목록': [139],
    '프로필 QR': [143],
    '프로필 수정': [148],
    '콘텐츠 추가': [149],
...
X_page2screen_indices = {
    "X_main": [0, 4, 6, 13, 28, 46, 47, 53, 54, 61, 74, 82, 83, 102, 119, 130, 149, 152, 167, 172, 174, 181, 194, 198, 206, 217, 244, 258, 285, 306, 317, 322],
    "X_main_post_added_message": [15, 35, 90, 183, 199],
    "X_main_undo_message": [56],
...
Facebook_page2screen_indices = {
    'facebook_main': [0, 4, 15, 17, 26, 43, 52, 65, 68, 84, 103, 118, 134, 155, 171, 186, 192, 205, 209, 225, 250, 265, 272, 273, 278, 288, 291],
    ...
    'main_menu': [9, 57, 79, 99, 114, 130, 146, 166, 214, 255, 296],
...
Coupang_page2screen_indices = {
    'coupang_main': [0, 25, 34, 39, 51, 56, 72, 77, 95, 104, 109, 119, 124, 127, 132, 148, 153, 176, 178, 190, 199, 204, 212, 217, 229, 234, 237, 242, 244, 254, 258, 263, 277, 290, 326, 330, 372],
...
Amazon_page2screen_indices = {
    'amazon_main': [0, 10, 30, 48, 53, 70, 79, 83, 87, 100, 117, 122, 125],
...
Temu_page2screen_indices = {
    'temu_main': [0, 2, 29, 34, 67, 89, 112, 117, 135, 137, 202, 161, 174, 187, 218, 232, 240, 261, 280, 328, 333, 350, 370, 391, 408, 436, 473, 156, 490],
...
page2screen_indices_dict = {
    ...
    "Amaozn": Amazon_page2screen_indices,
...
page_indices_dict = {
    ...
    "Amaozn": generate_page_indices(Amazon_page2screen_indices),
...
screen_idx2page_dict = {
    ...
    "Amaozn": generate_screen_idx2page(Amazon_page2screen_indices),
